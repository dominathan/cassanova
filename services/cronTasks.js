  ...
  // new CronJob('0 0 5 * * *', function() {
    try {
      new CronJob('*/30 * * * * *', function() {
        console.log("LETS BREAK SOME HSIT");
        getFakeAccounts()
        .then(function(allFakeAccounts) {
          console.log("LETS UPDATE SHIT");
          allFakeAccounts.forEach(function(oneFakeAccount) {
            console.log("HELLO", oneFakeAccount);
            console.log("LETS EMAIL", jwt.decode(oneFakeAccount.facebook_email,config.TOKEN_SECRET));
            // console.log("EMAIL", oneFakeAccount.facebook_email);
